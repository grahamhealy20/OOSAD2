...
public class SalesDAO {
	...
	public static boolean save(ormweek11.ormtest.Sales sales) throws PersistentException {
		try {
			ormweek11.ormtest.Ormweek11PersistentManager.instance().saveObject(sales);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(ormweek11.ormtest.Sales sales) throws PersistentException {
		try {
			ormweek11.ormtest.Ormweek11PersistentManager.instance().deleteObject(sales);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(ormweek11.ormtest.Sales sales) throws PersistentException {
		try {
			ormweek11.ormtest.Ormweek11PersistentManager.instance().getSession().refresh(sales);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(ormweek11.ormtest.Sales sales) throws PersistentException {
		try {
			ormweek11.ormtest.Ormweek11PersistentManager.instance().getSession().evict(sales);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
