...
public class EmployeeDAO {
	public static Employee loadEmployeeByORMID(int ID) throws PersistentException {
		try {
			PersistentSession session = ormweek11.ormtest.Ormweek11PersistentManager.instance().getSession();
	...
	public static boolean save(ormweek11.ormtest.Employee employee) throws PersistentException {
		try {
			ormweek11.ormtest.Ormweek11PersistentManager.instance().saveObject(employee);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(ormweek11.ormtest.Employee employee) throws PersistentException {
		try {
			ormweek11.ormtest.Ormweek11PersistentManager.instance().deleteObject(employee);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(ormweek11.ormtest.Employee employee) throws PersistentException {
		try {
			ormweek11.ormtest.Ormweek11PersistentManager.instance().getSession().refresh(employee);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(ormweek11.ormtest.Employee employee) throws PersistentException {
		try {
			ormweek11.ormtest.Ormweek11PersistentManager.instance().getSession().evict(employee);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
